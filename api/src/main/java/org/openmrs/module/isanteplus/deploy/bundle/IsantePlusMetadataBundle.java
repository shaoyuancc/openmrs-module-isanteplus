...
public class IsantePlusMetadataBundle extends AbstractMetadataBundle {
	...
	public void install() {
		...
		// CCSY EDITED
//		properties.put(ConfigurableGlobalProperties.REGISTRATIONCORE_BIOMETRICS_PERSONIDENTIFIERTYPEUUID, IsantePlusConstants.HaitiCore_BIOMETRIC_UUID);
//		properties.put(ConfigurableGlobalProperties.REGISTRATIONCORE_BIOMETRICS_NATIONALPERSONIDENTIFIERTYPEUUID, IsantePlusConstants.HaitiCore_BIOMETRIC_NATIONAL_UUID);
		...
		// CCSY EDITED
//		properties.put(ConfigurableGlobalProperties.REGISTRATIONCORE_LOCAL_MPI_IDENTIFIERTYPEMAP_Biometrics_Reference_Code, IsantePlusConstants.HaitiCore_BIOMETRIC_NATIONAL_UUID + ":" + ConfigurableGlobalProperties.REGISTRATIONCORE_MPI_Biometrics_Reference_Code_UNIVERSAL_IDENTIFIER + ":" + ConfigurableGlobalProperties.REGISTRATIONCORE_MPI_M2Sys_Fingerprint_Registration_ID_UNIVERSAL_IDENTIFIER_TYPE);
		...
		properties.put(ConfigurableGlobalProperties.REGISTRATIONCORE_MPI_PDQ_IDENTIFIERTYPEUUIDLIST, IsantePlusConstants.PATIENT_IDENTIFIER_TYPE_UUID_ISANTEPLUS_ID + "," + IsantePlusConstants.HaitiCore_ECID_UUID + "," + /* CCSY EDITED IsantePlusConstants.HaitiCore_BIOMETRIC_NATIONAL_UUID + ","  + IsantePlusConstants.HaitiCore_BIOMETRIC_UUID + "," + */ IsantePlusConstants.PATIENT_IDENTIFIER_TYPE_UUID_CODE_NATIONAL + "," + IsantePlusConstants.PATIENT_IDENTIFIER_TYPE_UUID_CODE_ST);
